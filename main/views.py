...
def index(request):
    ...
    """
    page_title = _("Property Management System") 
...
class CustomerDetailView(PermissionRequiredMixin, generic.DetailView):
    """
    View for detail of Tenant
    Implements generic DetailView
    """
    model = Customer
    title = _("Tenant Information")
...
class GuestListView(PermissionRequiredMixin, generic.ListView):
    """
    View for list of guests present in the unit.
    """
    model = Customer
    paginate_by = 5
    allow_empty = True
